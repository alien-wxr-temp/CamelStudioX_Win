...
/*************** IO Setup***************/
#define RT_IOCTL_Set1(n, oe) 	MemoryWrite32(SYS_IOCTL_REG, oe<<n)
...
#define RT_GPIO_Write1(n, v)	MemoryWrite32(SYS_GPIO0_REG, v<<n)
#define RT_GPIO_Read1(n)		((MemoryRead32(SYS_GPIO1_REG)&(1<<n))>>n)
#define RT_GPIO_Read16()		MemoryRead32(SYS_GPIO1_REG)
